            ...
            @foreach($categories as $categorie)
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('categories.show', $categorie->id) }}" class="btn btn-info btn-icon"><i class="fas fa-info-circle"></i></a>
                        @auth
                            <a href="{{ route('categories.edit', $categorie->id) }}" class="btn btn-warning btn-icon"><i class="fas fa-edit"></i></a>
